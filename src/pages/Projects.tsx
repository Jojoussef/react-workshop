...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      images: [
        "src/assets/AccApp/Splash screen (2).png",
        "src/assets/AccApp/Sign Up.png",
        "src/assets/AccApp/Select Community.png",
        "src/assets/AccApp/Main Activity.png",
        "src/assets/AccApp/Community Map.png",
        "src/assets/AccApp/Chats.png",
        "src/assets/AccApp/Calls.png",
        "src/assets/AccApp/Single update.png",
        "src/assets/AccApp/Group.png",
        "src/assets/AccApp/Events.png",
      ],
      type: "mobile",
    },

    {
      ...
      images: [
        ...
        "src/assets/admin-dashboard/2.png",
